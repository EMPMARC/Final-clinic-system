...
const ModifyBookingPage = () => {
  ...
  const searchAppointments = async () => {
    ...
    try {
      const response = await fetch(`${config.API_URL}/api/appointments/student/${studentNumber}`);
  ...
  const updateAppointment = async () => {
    ...
    try {
      const response = await fetch(`${config.API_URL}/api/appointments/${selectedAppointment.id}`, {
        method: "PUT",
        headers: {
  ...
  const cancelAppointment = async () => {
    ...
    try {
      const response = await fetch(`${config.API_URL}/api/appointments/${selectedAppointment.id}/cancel`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
